export const ERR_URL_OPTION_REQUIRED = 'The `url` option is required'
...
export const ERR_NO_STEPS = 'Workflows must contain a steps array'
export const ERR_NO_STEP = 'Workflows must have at least one step in the steps array'
export const ERR_STEP_INVALID = 'Each step in a workflow should be a non-empty string'
